...
const TestData = {
  ...
  secretKey:
    "whuNSscDwRXrZMAZhzAO0eFDzA3eVeZwq0W039K90wBkZh7+8FlU2TNDp8PwGaQlRvqjSnzB8q3c+oVXHr5t7g==",
};
...
export class AccessKeyTestSuite {
  ...
  generate_access_key() {
    ...
    expect.toBeEqual(access_key.length, 44);
    expect.toBeTrue(Base64.isValid(access_key));
  }
